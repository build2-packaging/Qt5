...
int main(int argc, char *argv[])
{
  ...
  {
    printf ("# build2 buildfile qt5uic\n");
    printf ("export.metadata = 1 qt5uic\n");
    printf ("qt5uic.name = [string] uic\n");
    printf ("qt5uic.version = [string] '%s'\n", QT_VERSION_STR);
    printf ("qt5uic.checksum = [string] '%s'\n", QT_VERSION_STR);
    return 0;
  }
