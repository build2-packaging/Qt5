...
int main(int argc, char *argv[])
{
    ...
    {
      printf ("# build2 buildfile qt5rcc\n");
      printf ("export.metadata = 1 qt5rcc\n");
      printf ("qt5rcc.name = [string] rcc\n");
      printf ("qt5rcc.version = [string] '%s'\n", QT_VERSION_STR);
      printf ("qt5rcc.checksum = [string] '%s'\n", QT_VERSION_STR);
